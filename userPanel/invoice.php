        ...
        <div id="invoice-template" class="card-body">
            <center>
                ...
                <?php
                    ...
                    {
                        $orderIDNew = $_GET['view'];
                        $c_price = $orderRow['c_price']*100;
                        $c_price = $c_price * 270;
                        $countGetData = 0;
                        ...
                        {
                            $url = "https://acquiring.meezanbank.com/payment/rest/register.do?userName=Htmetal_api&password=H987658&orderNumber=".$orderIDNew."&amount=".$c_price."&currency=586&returnUrl=https://hotmetallogos.com/new/orders.php?orderID=".$orderIDNew."";
                            $ch = curl_init();
