    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <p class="card-title">Canceled Orders</p>
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table class="display expandable-table" style="width:100%">
                                        ...
                                        <?php
                                        $i = 0;
                                        $sql = mysqli_query($db, "SELECT * FROM `orders` WHERE status = 'Canceled' AND email = '".$_SESSION['email']."' ORDER by id DESC");
                                        while ($row = mysqli_fetch_array($sql))
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td class="f_s_12 f_w_400 color_text_6">
                                                    <a href="editStatus.php?orderId=<?php echo $row['orderid'] ?>" class="btn btn-info">
                                                        <?php echo $row['status']; ?>
                                                    </a>
                                                </td>
